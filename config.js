...
global.caption = process.env.CAPTION || global.caption || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ MBUVI-MD" 
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ MBUVI²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • MBUVI ᴛᴇᴄʜ』*\n t.me/mbuvi"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "MBUVI-ᴍᴅ",
  ownername:process.env.OWNER_NAME|| "It'x MBUVI",
  ...
  LANG: ( process.env.THEME ||  "MBUVI"  ).toUpperCase(),
